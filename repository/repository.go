...
// MealRepository is a concrete repository that implements repository.
type mealRepository struct {
	*repository
}

// NewMealRepository is constructor for mealRepository.
func NewMealRepository(logger logger.Logger, conf *config.Config) Repository {
	...
	return &mealRepository{&repository{db: db}}
}
